  ...
  return (
    <div className="absolute top-80 left-16 h-screen font-sans subpixel-antialiased flex flex-col gap-5 text-white">
      ...
      <div className=" flex gap-2.5 items-center font-semibold">
        <button className="px-6 py-2 bg-white/80   flex gap-2.5 items-center rounded text-black hover:bg-white">
          <img
        ...
        <button className="px-3 py-2 bg-white/80 flex gap-2.5 items-center rounded text-black hover:bg-white">
          <img
