...
console.log(videoDetail);
  ...
  return (
    <div className="absolute top-80 left-10 font-sans subpixel-antialiased flex flex-col gap-5 text-white">
      <h1 className="font-bold text-4xl">{title}</h1>
      <p className="w-1/2 font-normal">{overview}</p>
      <div className=" flex gap-2.5 items-center font-semibold">
        <button className="px-6 py-2 bg-white  flex gap-2.5 items-center rounded text-black">
          <img
        ...
        <button className="px-3 py-2 bg-gray-500  flex gap-2.5 items-center rounded text-white">
          <img
